...
public class TaskEventServiceImpl implements TaskEventService {
    ...
    @Override
    @UnitOfWork
    public void writeEvent(UUID depositId, TaskEvent.EventType eventType, TaskEvent.Result result, String message) {
        taskEventDAO.save(new TaskEvent(OffsetDateTime.now(), depositId, eventType, result, message));
    }
}
